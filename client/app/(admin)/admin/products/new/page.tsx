        ...
        <div className="max-w-5xl animate-fade-in pb-32">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Create <span className="text-primary">Product</span></h1>
                        <p className="text-slate-500 font-medium mt-1 text-sm tracking-tight">Add a masterpiece to your collection.</p>
                    </div>
                </div>

                <div className="flex items-center gap-3">
                    <Link href="/admin/products" className="btn btn-ghost px-6 font-semibold text-slate-400 lowercase">cancel</Link>
