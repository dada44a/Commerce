export default function Footer() {
    return (
        <div>
            <footer className='bg-black py-12 px-4 sm:px-6 lg:px-8 mt-50'>
                <div className='w-full max-w-7xl mx-auto'>

                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">

                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                            <a href="https://prebuiltui.com" className="text-white font-bold text-3xl">
                                Nexa Commerce
                            </a>
                        ...
                        <div className="w-full md:w-[45%] lg:w-[25%] flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <div className="flex items-center border gap-2 border-white/20 h-13 max-w-80 w-full rounded-full overflow-hidden mt-4">
                                ...
                                <button type="submit" className="bg-linear-to-b from-primary to-secondary active:scale-95 transition w-56 h-10 rounded-full text-sm text-white cursor-pointer mr-1.5">Subscribe</button>
                            </div>
                        </div>
